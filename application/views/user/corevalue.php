...
<html lang="zxx">
<head>
	<title>Nilai Perusahaan | PT Tri Ratna Diesel Indonesia</title>
	<meta charset="UTF-8">
	<!-- Favicon -->
		...
		<div class="site-navbar">
			...
			<nav class="site-nav-menu">
				<ul>
					...
					<li class="active"><a href="<?php base_url();?>">Profil</a></li>
					<li><a>Unit</a>
						<ul class="sub-menu">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 sidebar order-2 order-lg-1">
					<div class="sb-widget">
						...
						<ul>
							...
							<li><a href="<?php site_url();?>">Company Value</a></li>
				...
				<div class="col-lg-8 order-1 order-lg-2" >
					<div class="blog-post tab-pane fade show active" id="profil" role="tabpanel" >
						<h2 style="color: #DAA520;">Company Value</h2><br>
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="service-item">
									<div class="si-head">
										<div class="si-icon">
											<img src="<?php site_url();?>../assets/user/img/icons/wind-engine.png" alt="">
										</div>
										<h5>Customer Focus</h5>
									</div>
									<p>Untuk melanjutkan eksistensi dari Perusahaan dengan cita-cita mulia menjadi pilihan utama bagi pelanggan, dengan harapan menjadi perusahaan yang paling dikagumi dan memberikan kesejahteraan bagi bangsa.</p>
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="service-item">
									<div class="si-head">
										<div class="si-icon">
											<img src="<?php site_url();?>../assets/user/img/icons/cogwheel.png" alt="">
										</div>
										<h5>Respect</h5>
									</div>
									<p>Respek kepada setiap individu dengan fokus pengembangan yang terus menerus menjadi aset yang bermanfaat.</p>
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="service-item">
									...
									<p>Selalu berusaha mencapai yang terbaik dari waktu ke waktu.</p>
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="service-item">
									...
									<p>Inovasi yang lebih baik, efisien dan efektif dalam pencapaian kerja yang menyenangkan dalam lingkungan maupun proses untuk memberikan hasil sempurna.</p>
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="service-item">
									...
									<p>Membuat dan menghasilkan produk yang aman dan bermanfaat untuk Pelanggan serta Insan Tri Ratna.</p>
								</div>
							</div>
						</div>
					</div>
